...
HomeCage Server は REST endpoints を提供します。
...
`HOMECAGE_HA_MQTT_HOST` を設定すると、サーバーは MQTT Discovery を公開します: 紛失モード switch、位置情報リクエスト button、許可アプリ数、位置情報ステータス、最後の電話レポートの sensors。
