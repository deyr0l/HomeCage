...
При первом контакте новое устройство на сервере принимает локальный список разрешенных приложений с телефона. После сохранения конфига в веб-админке или API сервер становится источником истины для этого устройства.
